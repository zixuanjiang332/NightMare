...
public enum BrandType {
    ...
    BLIND_STRIKE("BLIND_STRIKE", "§8致盲术", "§7攻击有15%概率使敌人失明 (2秒)", 60),
    HARD_LANDING("HARD_LANDING", "§b强行着陆", "§7彻底免疫下一次摔落伤害", 45),
    SECOND_ROUND("SECOND_ROUND", "§d第二回合", "§7濒死受击时, 5%概率直接在副手生成不死图腾", 300),
    BARRIER("BARRIER", "§6屏障", "§7血量低于50%受击时, 百分之30概率获得 3 颗额外黄心护盾 (10秒)[冷却60s]", 60),
    SHOCKWAVE("SHOCKWAVE", "§6震撼", "§7攻击有15%概率造成巨额击退并将敌人击飞", 90),
    THUNDER_ROAR("THUNDER_ROAR", "§e奔雷怒吼", "§7攻击有10%概率召唤雷电并造成额外 4 点真实伤害", 45),
